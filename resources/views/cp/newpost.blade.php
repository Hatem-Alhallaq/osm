                        ...
                        <form action="#">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control">
                                    ...
                                    <option>صورة</option>
                                    <option>فيديو</option>
                                    <option>استطلاع رأي</option>
                                </select>
                            </div>

                            <div class="form-group">
                                <label>رابط الفيديو:</label>
                                <input type="text" class="form-control" placeholder="أدخل الرابط">
                            </div>

                            <div class="form-group">
                                <label>التفاصيل:</label>
                                <textarea rows="5" cols="5" class="form-control" placeholder="أدخل تفاصيل المنشور"></textarea>
                            </div>

                            <div class="form-group">
                                <label>الصورة:</label>
                                <input type="file" class="form-control" placeholder="أدخل العنوان">
                            </div>
